  ...
  return (
    <div className="rounded-2xl bg-white/[0.03] border border-white/[0.06] p-6">
      ...
      <div className="flex flex-wrap gap-3">
        <button className="flex items-center gap-2 px-5 py-2.5 rounded-xl bg-emerald-500 hover:bg-emerald-600 text-white text-sm font-medium transition-colors shadow-lg shadow-emerald-500/20" onClick={() => alert("Enterprise Reporting (PDF) service is mocked in this phase.")}>
          <Download size={15} />
          Download Report
        </button>
        <button 
        ...
        <button className="flex items-center gap-2 px-5 py-2.5 rounded-xl bg-white/[0.06] hover:bg-white/[0.1] text-white/80 text-sm font-medium transition-colors border border-white/[0.08]" onClick={() => alert("Enterprise Reporting (PDF) service is mocked in this phase.")}>
          <FileText size={15} />
          Generate PDF
        </button>
